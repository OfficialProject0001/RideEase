...
export default function App() {
    ...
    const LandingPage = () => (
        <div className="container-fluid min-vh-100 d-flex flex-column justify-content-center align-items-center text-center text-white position-relative">
            ...
            <div 
                className="glass-card p-5 d-flex flex-column gap-3 shadow-lg" 
                style={{ width: '400px' }}
            >
                <button 
                    onClick={() => navigateTo('login', 'customer')} 
                    className="btn btn-purple py-3 fw-bold fs-5"
                >
                    Rider Login
                </button>
                ...
                <button 
                    ...
                    className="btn btn-outline-purple py-3 fw-bold fs-5"
                >
                    Captain Login
                </button>
    ...
    // ==========================================
    // AUTH PAGE COMPONENT (WITH NITIN01 BYPASS)
    // ==========================================
    const AuthPage = () => {
        ...
        const handleSubmit = async (e) => {
            ...
            // 🚨 ADMIN ID & PASSWORD CHECK 🚨
            if (role === 'admin') {
                if (phone.trim() === 'Nitin01' && password.trim() === 'Nitin2580@') {
                    finalizeLogin({ 
                        phone: 'Nitin01', 
                        role: 'admin', 
                        name: 'Boss Nitin Sharma' 
                    });
                    setIsLoading(false); 
                    return; 
                } else {
        ...
        return (
            <div className="container min-vh-100 d-flex justify-content-center align-items-center bg-black">
                ...
                <div 
                    className="glass-card p-5 animate__animated animate__fadeIn shadow-lg" 
                    style={{ width: '420px' }}
                >
                    ...
                    {authStep === 'phone' ? (
                        <form onSubmit={handleSubmit}>
                            <div className="mb-3 text-start">
                                ...
                                <input 
                                    ...
                                    placeholder={role === 'admin' ? "Enter Nitin01" : "10-digit number"} 
                                    value={phone} 
                            ...
                            <button 
                                type="submit" 
                                disabled={isLoading} 
                                className="btn btn-purple w-100 py-3 mt-4 fw-bold fs-5"
                            >
                        ...
                        <form onSubmit={handleRegister}>
                            ...
                            <button 
                                type="submit" 
                                disabled={isLoading} 
                                className="btn btn-purple w-100 py-3 mt-2 fw-bold fs-5"
                            >
    ...
    const CustomerPanel = () => {
        ...
        // 🚖 NAYA STATE: Nearby Drivers
        const [nearbyDrivers, setNearbyDrivers] = useState([]);

        // 🚨 8 Rs/Km Set for Bike 🚨
        const vehicles = [
            { 
                id: 'bike', 
                name: 'Bike', 
        ...
        // 🚖 NAYA LOGIC: Generate Nearby Vehicles when Selection changes
        useEffect(() => {
            if (pickupCoords && selectedVehicle && rideState === 'select_vehicle') {
                ...
                for (let i = 0; i < numDrivers; i++) {
                    ...
                    drivers.push({
                        id: i,
                        lat: pickupCoords[0] + latOffset,
                        lng: pickupCoords[1] + lngOffset,
        ...
        const handleSearchVehicles = async () => {
            if(!pickupLoc || !dropLoc) {
                return alert("Please enter both Pickup and Drop locations! (Hint: Add city name for better accuracy)");
            }
            ...
            try {
                ...
                if(pickRes.data.length > 0 && dropRes.data.length > 0) {
                    ...
                    alert("Location not found on map! Please write area and city clearly. (e.g. Virar Station, Mumbai)"); 
                    setRideState('idle'); 
                }
            } catch (err) { 
                setRideState('idle'); 
        ...
        const handleVehicleSelection = (v) => {
            if(v.isDemo) { 
                ...
                if(password !== "Nitin2580@") {
                    return alert("❌ Incorrect Password! Demo ride locked."); 
                }
            }
        ...
        const handleRazorpayPayment = async () => {
            ...
            try {
                const orderObj = await axios.post(`${SERVER_URL}/api/create-razorpay-order`, { 
        ...
        return (
            <div className="container-fluid min-vh-100 p-0 row m-0 text-white">
                ...
                <div 
                    className="col-md-3 glass-card border-end-0 border-end border-purple p-4 d-flex flex-column h-100 min-vh-100 rounded-0 z-3" 
                ...
                >
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'home' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        📍 Book VIP Ride
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'history' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        📜 Ride History
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'wallet' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        💼 Digital Wallet
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'refer' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        🎁 Refer & Earn
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-5 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'profile' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        ⚙️ Preferences
                    </button>
                    ...
                    <button 
                        ...
                        className="btn btn-outline-danger w-100 mt-auto fw-bold py-3 rounded-pill"
                    >
                        Secure Logout
                    </button>
                </div>
                ...
                <div className="col-md-9 p-4 p-md-5">
                    ...
                    {activeTab === 'home' && (
                        <div 
                            className="glass-card p-4 p-md-5 mx-auto animate__animated animate__fadeIn" 
                        ...
                        >
                            ...
                            <div className="mb-5 map-glow" style={{height: '250px'}}>
                                ...
                                >
                                    ...
                                    {/* 🚖 DYNAMIC NEARBY VEHICLE ICONS */}
                                    {nearbyDrivers.map(driver => (
                                        <Marker 
                                            key={driver.id} 
                                            position={[driver.lat, driver.lng]} 
                                            icon={createVehicleIcon(driver.icon)} 
                                        />
                                    ))}
                            ...
                            {rideState === 'idle' && (
                                <div className="animate__animated animate__fadeInUp">
                                    <h3 className="fw-bold text-white mb-4">
                                        Book Your <span className="text-gradient">VIP Ride</span>
                                    </h3>
                                    
                                    <div 
                                        className="p-4 rounded-4 border border-secondary mb-4" 
                                    ...
                                    >
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <input 
                                                type="text" 
                                                className="form-control bg-transparent border-0 fs-5" 
                                                placeholder="Pickup Location (e.g. Virar Station, Mumbai)" 
                                                value={pickupLoc} 
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <input 
                                                type="text" 
                                                className="form-control bg-transparent border-0 fs-5" 
                                                placeholder="Drop Location (e.g. Viva College, Virar)" 
                                                value={dropLoc} 
                                    ...
                                    <button 
                                        ...
                                        className="btn btn-purple w-100 py-3 fs-4 fw-bold"
                                    >
                                ...
                                <div className="animate__animated animate__fadeInRight">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <button 
                                            ...
                                            className="btn btn-sm text-gradient fw-bold"
                                        >
                                            ✎ Edit Route
                                        </button>
                                    </div>
                                    ...
                                    <div 
                                        className="d-flex flex-column gap-3 mb-4 pr-2" 
                                    ...
                                    >
                                        {vehicles.map(v => (
                                            <div 
                                                ...
                                                className={`vehicle-card d-flex justify-content-between align-items-center p-4 border ${
                                                    selectedVehicle.id === v.id ? 'selected' : 'border-secondary'
                                                }`} 
                                                style={selectedVehicle.id === v.id ? {borderColor: 'var(--vip-neon)'} : {}}
                                            >
                                                <div className="d-flex align-items-center gap-4">
                                                    <span 
                                                        style={{fontSize: '2.5rem', filter: 'drop-shadow(0px 4px 6px rgba(0,0,0,0.3))'}}
                                                    >
                                                        {v.icon}
                                                    </span>
                                                    <span className="fw-bold text-white fs-4">
                                                        {v.name} 
                                                        {v.isDemo && (
                                                            <span className="badge bg-danger ms-2 fs-6">Admin</span>
                                                        )}
                                                    </span>
                                                </div>
                                                <span 
                                                    className={`fw-bold fs-3 ${v.isDemo ? 'text-danger' : 'text-gradient'}`}
                                                >
                                                    ₹ {getDynamicFare(v)}
                                                </span>
                                            </div>
                                    ...
                                    <div className="d-flex gap-3 mt-4">
                                        <button 
                                            ...
                                            className="btn btn-purple flex-grow-1 py-3 fs-5 fw-bold"
                                        >
                                            Pay Online ✨
                                        </button>
                                        ...
                                        <button 
                                            ...
                                            className="btn btn-outline-purple flex-grow-1 py-3 fs-5 fw-bold"
                                        >
                                            Pay Cash 💵
                                        </button>
                                    </div>
                            ...
                            {rideState === 'searching' && (
                                <div className="text-center py-5 floating-element">
                                    <div 
                                        className="spinner-border text-neon mb-4" 
                                        style={{width:'3rem', height:'3rem', color: 'var(--vip-neon)'}}
                                    >
                                    </div>
                            ...
                            {(rideState === 'accepted' || rideState === 'in_progress') && (
                                <div className="text-center py-4 animate__animated animate__zoomIn">
                                    ...
                                    <div 
                                        className="glass-card border border-purple p-4 text-start mb-4 mx-auto" 
                                        style={{maxWidth: '450px'}}
                                    >
                                        <h6 className="text-muted text-uppercase letter-spacing-1 mb-3">
                                            Driver Details
                                        </h6>
                                        <div className="d-flex align-items-center mb-3">
                                            <div 
                                                className="bg-purple text-white rounded-circle d-flex justify-content-center align-items-center me-4 shadow-lg" 
                                            ...
                                            <div>
                                                ...
                                                <p 
                                                    className="text-neon mb-0 fw-bold fs-5" 
                                                    style={{color: 'var(--vip-neon)'}}
                                                >
                                                    📞 {currentRide?.captainPhone}
                                                </p>
                                            </div>
                                        </div>
                                        <hr className="border-secondary"/>
                                        <p className="text-muted mb-0 fs-5">
                                            Vehicle: <strong className="text-white">{currentRide?.vehicle}</strong>
                                        </p>
                                    </div>
                                    
                                    {rideState === 'accepted' && (
                                        <div 
                                            className="glass-card border-neon p-4 d-inline-block" 
                                            style={{borderColor: 'var(--vip-neon)'}}
                                        >
                                            <p className="fw-bold mb-1 fs-5 text-muted">Your Secure OTP</p>
                                            <h1 className="fw-bold tracking-widest display-3 mb-0 text-white">
                                                {currentRide?.otp}
                                            </h1>
                                        </div>
                                    )}
                                    ...
                                    {currentRide?.paymentPref === 'Cash' ? (
                                        <div>
                                            ...
                                            <button 
                                                ...
                                                className="btn btn-purple w-100 py-3 fw-bold fs-4"
                                            >
                                        ...
                                        <div className="d-flex flex-column gap-3">
                                            <button 
                                                ...
                                                className="btn btn-purple py-3 fw-bold fs-4"
                                            >
                            ...
                            {rideState === 'completed' && (
                                <div className="text-center py-4 animate__animated animate__zoomIn">
                                    <div 
                                        id="receipt-card" 
                                        className="glass-card border-success p-5 text-start mx-auto" 
                                    ...
                                    <div className="mt-5 d-flex gap-3 justify-content-center">
                                        <button 
                                            onClick={downloadPDF} 
                                            className="btn btn-outline-purple fw-bold px-4 py-2 fs-5"
                                        >
                                            ⬇️ Download PDF
                                        </button>
                                        ...
                                        <button 
                                            onClick={resetToHome} 
                                            className="btn btn-purple fw-bold px-5 py-2 fs-5"
                                        >
                                            Home
                                        </button>
                                    </div>
                        ...
                        <div className="glass-card p-5 animate__animated animate__fadeIn">
                            ...
                            {rideHistory.length > 0 ? (
                                rideHistory.map((r, i) => (
                                    <div 
                                        key={i} 
                                        className="bg-black p-4 rounded-4 mb-4 border border-secondary d-flex flex-column shadow"
                                    >
                                        <div className="d-flex justify-content-between align-items-center">
                                            ...
                                            <h4 className="text-gradient fw-bold mb-0">
                                                ₹{r[5]} 
                                                <span 
                                                    className="fs-6 text-muted d-block text-end" 
                                        ...
                                        <button 
                                            onClick={() => downloadHistoryPDF(r)} 
                                            className="btn btn-outline-purple align-self-end mt-3 fw-bold px-4"
                                        >
                                            ⬇️ Get PDF Receipt
                                        </button>
                                    </div>
                    ...
                    {activeTab === 'wallet' && (
                        <div className="glass-card p-5 text-white animate__animated animate__fadeIn">
                            ...
                            <button className="btn btn-purple mt-4 px-5 py-3 fw-bold fs-5">
                                Add Funds
                            </button>
                        </div>
                    )}
                    ...
                    {activeTab === 'refer' && (
                        <div className="glass-card p-5 text-center text-white animate__animated animate__fadeIn">
                            ...
                            <h1 className="fw-bold tracking-widest mt-4 display-4">
                                RIDE-{userData?.phone?.slice(0,4)}
                            </h1>
                            <p className="text-muted mt-3 fs-5">
                                Share this code with friends and earn VIP credits!
                            </p>
                        </div>
                    )}
                    ...
                    {activeTab === 'profile' && (
                        <div className="glass-card p-5 text-white animate__animated animate__fadeIn">
                            ...
                            <span className="badge bg-purple py-2 px-4 rounded-pill mt-3 fs-6">
                                VIP Rider Activated
                            </span>
                        </div>
                    )}
        ...
        return (
            <div className="container-fluid min-vh-100 p-0 row m-0 text-white">
                ...
                >
                    <div className="text-center mb-5 animate__animated animate__fadeIn floating-element">
                        <h3 className="fw-bold text-white">
                            <span className="text-gradient">Ride</span>Ease Captain
                        </h3>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'radar' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        📡 Live Radar
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'earnings' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        💰 Earnings
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold text-white border-0 py-3 px-4 ${
                            activeTab === 'vehicle' ? 'btn-purple' : 'btn-outline-purple'
                        }`}
                    >
                        🏍️ Vehicle Docs
                    </button>
                ...
                <div className="col-md-9 p-4 p-md-5">
                    ...
                    {activeTab === 'radar' && (
                        ...
                        >
                            ...
                            {activeRide ? (
                                <div className="glass-card p-5 text-center animate__animated animate__fadeIn">
                                    ...
                                    {activeRide.status === 'completed' ? (
                                        <div className="animate__animated animate__zoomIn">
                                            ...
                                            <div 
                                                className="bg-black border border-purple p-4 rounded-4 text-start mx-auto shadow-lg" 
                                                style={{maxWidth: '400px'}}
                                            >
                                                <h4 className="text-gradient fw-bold mb-4 text-center">
                                                    Earnings Receipt
                                                </h4>
                                        ...
                                        <>
                                            <div 
                                                ...
                                                style={{width:'3rem', height:'3rem', color:'var(--vip-neon)'}}
                                            ></div>
                                            <h3 className="fw-bold text-gradient tracking-widest">
                                                CONFIRMING...
                                            </h3>
                                            ...
                                            <div className="bg-black border border-secondary p-4 rounded-4 text-start mb-4 shadow">
                                                ...
                                                <div className="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 className="text-white fw-bold m-0">
                                                        <strong className="text-purple">Rider:</strong> {activeRide.riderName}
                                                    </h5>
                                                ...
                                                <p className="mb-2 text-white fs-5">
                                                    <strong className="text-purple">Pickup:</strong> {activeRide.pickup}
                                                </p>
                                                <p className="mb-3 text-white fs-5">
                                                    <strong className="text-purple">Drop:</strong> {activeRide.drop}
                                                </p>
                                                
                                                <hr/>
                                                <p className="mt-3 text-muted fw-bold fs-6">
                                                    Vehicle: {activeRide.vehicle} | Mode: {activeRide.paymentPref}
                                                </p>
                                            </div>
                                            ...
                                            {activeRide.status === 'payment_pending' ? (
                                                <div className="mt-4 p-4 border rounded-4 bg-black border-purple shadow">
                                                    {activeRide.paymentPref === 'Cash' ? (
                                                        ...
                                                        <>
                                                            <div 
                                                                className="spinner-grow text-neon mb-3" 
                                                                style={{color:'var(--vip-neon)'}}
                                                            ></div>
                                                ...
                                                <div className="mt-4 p-4 border rounded-4 bg-black border-purple animate__animated animate__fadeInUp">
                                                    ...
                                                    <input 
                                                        type="number" 
                                                        className="form-control text-center display-4 py-3 tracking-widest border border-purple" 
                                                        placeholder="----" 
                                                        value={otpInput} 
                                                    ...
                                                    <button 
                                                        onClick={verifyOTP} 
                                                        className="btn btn-purple w-100 py-3 fw-bold fs-4 mt-4"
                                                    >
                                                        Start VIP Ride 🔒
                                                    </button>
                                                </div>
                                                ...
                                                <button 
                                                    ...
                                                    className="btn btn-danger w-100 py-4 fs-4 fw-bold mt-4 shadow-lg rounded-4"
                                                >
                                ...
                                <div 
                                    className="glass-card p-5 text-center border-2" 
                                    style={{borderColor: 'var(--vip-neon)', boxShadow: '0 0 40px rgba(213,0,249,0.2)'}}
                                >
                                    <h2 className="text-gradient fw-bold mb-3 animate__animated animate__pulse animate__infinite">
                                        🔥 VIP Request!
                                    </h2>
                                    
                                    {incomingRide.isDemo && (
                                        <h4 className="text-danger fw-bold animate__animated animate__flash animate__infinite mb-3">
                                            🚨 ₹1 DEMO RIDE 🚨
                                        </h4>
                                    )}
                                    
                                    <div className="bg-black p-4 rounded-4 my-4 text-start">
                                        <p className="fs-4 text-white mb-2">
                                            <span className="text-muted fs-5">Rider:</span> <strong>{incomingRide.riderName}</strong>
                                        </p>
                                        <p className="fs-5 text-white mb-2">
                                            <span className="text-muted fs-6">Pickup:</span> <strong>{incomingRide.pickup}</strong>
                                        </p>
                                        <p className="fs-6 text-muted mt-3 pt-3 border-top border-secondary">
                                            Vehicle: {incomingRide.vehicle} | Pay: {incomingRide.paymentPref}
                                        </p>
                                    </div>
                                    ...
                                    <div className="d-flex gap-4 mt-4">
                                        <button 
                                            onClick={acceptRide} 
                                            className="btn btn-purple flex-grow-1 py-3 fw-bold fs-4 shadow-lg"
                                        >
                                            ACCEPT
                                        </button>
                                        <button 
                                            onClick={()=>setIncomingRide(null)} 
                                            className="btn btn-outline-danger flex-grow-1 py-3 fw-bold fs-5"
                                        >
                                            REJECT
                                        </button>
                                    </div>
                                ...
                                <div className="text-center mt-5 floating-element">
                                    <div 
                                        className="spinner-grow mb-4" 
                                        style={{width:'4rem', height:'4rem', color:'var(--vip-neon)'}}
                                    ></div>
                    ...
                    {activeTab === 'earnings' && (
                        <div className="glass-card p-5 text-center animate__animated animate__fadeIn">
                            ...
                            <h1 className="text-success display-1 fw-bold">
    ...
    const AdminPanel = () => {
        ...
        useEffect(() => { 
            socket.on('admin_update', (data) => { 
                ...
                if(data.type === 'complete_ride') { 
                    setStats(prev => ({ 
                        active: prev.active - 1 > 0 ? prev.active - 1 : 0, 
        ...
        return (
            <div className="container-fluid min-vh-100 p-0 row m-0 text-white">
                ...
                {/* ADMIN SIDEBAR */}
                <div 
                    className="col-md-3 glass-card border-end-0 border-end border-danger p-4 d-flex flex-column h-100 min-vh-100 rounded-0 z-3" 
                    style={{borderRight: '1px solid rgba(255,255,255,0.05)'}}
                >
                    <div className="text-center mb-5 mt-3 floating-element">
                        <h3 className="text-danger fw-bold tracking-widest text-shadow">
                            ADMIN
                        </h3>
                        <div className="badge bg-danger text-white py-2 px-4 rounded-pill mt-2 fw-bold">
                            Boss Nitin Sharma
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold py-3 px-4 ${
                            activeTab === 'dash' ? 'btn-danger text-black' : 'btn-outline-danger text-white'
                        }`}
                    >
                        📈 Analytics Dashboard
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold py-3 px-4 ${
                            activeTab === 'liverides' ? 'btn-danger text-black' : 'btn-outline-danger text-white'
                        }`}
                    >
                        📍 Live Global Map
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold py-3 px-4 ${
                            activeTab === 'users' ? 'btn-danger text-black' : 'btn-outline-danger text-white'
                        }`}
                    >
                        👥 User Management
                    </button>
                    ...
                    <button 
                        ...
                        className={`btn text-start mb-3 fw-bold py-3 px-4 ${
                            activeTab === 'settings' ? 'btn-danger text-black' : 'btn-outline-danger text-white'
                        }`}
                    >
                        ⚙️ Platform Settings
                    </button>
                    ...
                    <button 
                        onClick={handleLogout} 
                        className="btn btn-outline-secondary w-100 mt-auto fw-bold py-3 rounded-pill text-white"
                    >
                        System Logout
                    </button>
                </div>
                        ...
                        <div className="animate__animated animate__fadeIn">
                            ...
                            <div className="glass-card p-5 border-danger text-center w-50">
                                ...
                                <h2 className="text-success fw-bold m-0">
                                    SOCKET LIVE 
                                    <span className="text-white fw-light fs-4 ms-2">
                                        ✅ {io().connected ? 'Online' : 'Connecting...'}
                                    </span>
                                </h2>
                            </div>
                        </div>
                        ...
                        <div className="glass-card p-5 animate__animated animate__fadeIn">
                            ...
                            <div className="row g-5">
                                <div className="col-md-6">
                                    ...
                                    <input 
                                        type="number" 
                                        className="form-control py-3 fs-5 text-center" 
                                        defaultValue="10" 
                                    />
                                ...
                                <div className="col-12 mt-5 text-end">
                                    <button 
                                        className="btn btn-purple px-5 py-3 fw-bold fs-5 shadow-lg" 
