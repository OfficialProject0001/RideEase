...
export default function App() {
  ...
  const VIPTheme = () => (
    <style>{`
      ...
      .border-purple { 
          border-color: var(--vip-purple) !important; 
      }
      ...
      .btn-purple:hover { 
          background-color: var(--vip-dark) !important; 
          color: white !important; 
  ...
  const BackButton = ({ onClick }) => (
    <div className="position-absolute top-0 start-0 m-4">
      <button 
          onClick={onClick} 
          className="btn btn-outline-purple rounded-circle fw-bold" 
    ...
    <div className="container-fluid min-vh-100 d-flex flex-column justify-content-center align-items-center text-center bg-black text-white">
      ...
      <div className="mb-4 animate__animated animate__fadeInDown">
          <h1 className="display-3 fw-bold mb-2 text-white">
              <span className="text-purple">Ride</span>Ease
          </h1>
          <p className="text-muted mb-5 fs-5" style={{fontWeight: 300}}>
              Exclusive Mobility, VIP Standard Service.
          </p>
      </div>
      ...
      <div className="glass-card p-5 d-flex flex-column gap-3 rounded-4" style={{ width: '380px' }}>
        ...
        <button 
            onClick={() => navigateTo('login', 'customer')} 
            className="btn btn-purple py-3 fw-bold fs-5 rounded-pill"
        >
            Rider Login
        </button>
        
        <button 
            onClick={() => navigateTo('login', 'captain')} 
            className="btn btn-outline-purple py-3 fw-bold fs-5 rounded-pill"
        >
            Captain Login
        </button>
        ...
        <button 
            ...
            className="btn btn-link text-purple text-decoration-none fw-bold w-100"
        >
            Admin Portal
        </button>
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (res.data.isNew && role !== 'admin') { 
          ...
          console.log("Server is waking up from sleep mode..."); 
      } finally {
          setIsLoading(false);
      }
    };
    ...
    return (
      <div className="container min-vh-100 d-flex justify-content-center align-items-center bg-black">
        ...
        <div className="glass-card p-5 rounded-4 animate__animated animate__fadeIn" style={{ width: '420px' }}>
          ...
          <h4 className="mb-4 text-center text-purple fw-bold letter-spacing-1">
          ...
          {authStep === 'phone' ? (
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3 text-start">
                ...
                <input 
                    ...
                    placeholder={role === 'admin' ? "Enter Admin ID" : "10-digit mobile number"} 
                    value={phone} 
              ...
              <button 
                  type="submit" 
                  disabled={isLoading} 
                  className="btn btn-purple w-100 py-3 mt-3 fw-bold fs-5 rounded-pill"
              >
            ...
            <form onSubmit={handleRegister}>
              ...
              <button 
                  type="submit" 
                  disabled={isLoading} 
                  className="btn btn-purple w-100 py-3 fw-bold fs-5 rounded-pill"
              >
  ...
  const CustomerPanel = () => {
    ...
    const getDynamicFare = (v) => {
        return Math.round(v.base + (v.perKm * calculatedDistance));
    };
    ...
    return (
      <div className="container-fluid min-vh-100 p-0 row m-0 bg-black text-white">
          ...
          <div className="col-md-3 bg-dark border-end border-purple p-4 d-flex flex-column h-100 min-vh-100 shadow-lg">
              <div className="text-center mb-5 animate__animated animate__fadeIn">
                  <h4 className="fw-bold text-white">
                      <span className="text-purple">Ride</span>Ease Rider
                  </h4>
                  <div className="badge bg-purple text-white py-2 px-3 rounded-pill mt-2 fw-bold">
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold text-white border-0 ${activeTab==='home'?'bg-purple':'btn-dark'}`}
              >
                  📍 Book Ride
              </button>
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold text-white border-0 ${activeTab==='history'?'bg-purple':'btn-dark'}`}
              >
                  📜 My History
              </button>
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold text-white border-0 ${activeTab==='wallet'?'bg-purple':'btn-dark'}`}
              >
                  💼 Wallet
              </button>
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold text-white border-0 ${activeTab==='refer'?'bg-purple':'btn-dark'}`}
              >
                  🎁 Refer & Earn
              </button>
              ...
              <button 
                  ...
                  className={`btn text-start mb-5 fw-bold text-white border-0 ${activeTab==='profile'?'bg-purple':'btn-dark'}`}
              >
                  ⚙️ Profile Settings
              </button>
              ...
              <button 
                  ...
                  className="btn btn-outline-danger w-100 mt-auto fw-bold rounded-pill"
              >
                  Logout
              </button>
          </div>
          ...
          <div className="col-md-9 p-4 p-md-5 bg-black">
             {activeTab === 'home' && (
                 <div className="glass-card p-4 rounded-4 mx-auto" style={{maxWidth:'600px'}}>
                     ...
                     <div className="mb-4 rounded-4 overflow-hidden shadow border border-purple position-relative" style={{height: '250px'}}>
                         <MapContainer 
                             key={pickupCoords ? pickupCoords[0] : 'default'} 
                             center={mapCenter} 
                             zoom={13} 
                         ...
                         >
                             ...
                             {routeCoords.length > 0 && (
                                 <Polyline positions={routeCoords} color="#8A2BE2" weight={5} />
                             )}
                     ...
                     {rideState === 'idle' && (
                        <div className="animate__animated animate__fadeIn">
                            ...
                            <div className="bg-dark p-3 rounded-4 border border-purple mb-4">
                                <div className="d-flex align-items-center mb-2">
                                    ...
                                    <input 
                                        ...
                                        placeholder="Pickup Location (e.g. Virar Station)" 
                                        value={pickupLoc} 
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <input 
                                        type="text" 
                                        className="form-control bg-transparent border-0" 
                                        placeholder="Drop Location (e.g. Viva College)" 
                                        value={dropLoc} 
                            ...
                            <button 
                                ...
                                className="btn btn-purple w-100 py-3 fs-5 fw-bold rounded-4 shadow-sm"
                            >
                        ...
                        <div className="animate__animated animate__fadeInRight">
                            <div className="d-flex justify-content-between align-items-center mb-3">
                                <h6 className="fw-bold mb-0 text-white">
                                    Select Vehicle (Route: {calculatedDistance} KM)
                                </h6>
                                <button 
                                    onClick={() => { 
                                        setRideState('idle'); 
                                    ...
                                    className="btn btn-sm btn-link text-purple text-decoration-none fw-bold"
                                >
                                    ✎ Edit Route
                                </button>
                            </div>
                                ...
                                {vehicles.map(v => (
                                    ...
                                    >
                                        <div className="d-flex align-items-center gap-3">
                                            <span style={{fontSize: '2.5rem', filter: 'drop-shadow(2px 2px 2px rgba(0,0,0,0.1))'}}>
                                                {v.icon}
                                            </span>
                            ...
                            <div className="d-flex gap-2">
                                <button 
                                    onClick={()=>requestRideWithPaymentPref('Online')} 
                                    className="btn btn-purple flex-grow-1 py-3 fs-5 fw-bold rounded-pill"
                                >
                                    Pay Online ✨
                                </button>
                                <button 
                                    onClick={()=>requestRideWithPaymentPref('Cash')} 
                                    className="btn btn-outline-purple flex-grow-1 py-3 fs-5 fw-bold rounded-pill"
                                >
                                    Pay Cash 💵
                                </button>
                            </div>
                     ...
                     {(rideState === 'accepted' || rideState === 'in_progress') && (
                         <div className="text-center py-4 animate__animated animate__zoomIn">
                            <h2 className="text-purple fw-bold mb-3">
                            ...
                            <div className="bg-dark border border-purple rounded-4 p-4 text-start mb-4 shadow-lg mx-auto" style={{maxWidth: '400px'}}>
                                ...
                                <div className="d-flex align-items-center mb-3">
                                    <div className="bg-purple text-white rounded-circle d-flex justify-content-center align-items-center me-3" style={{width: '50px', height: '50px', fontSize: '1.5rem'}}>
                                        👨‍✈️
                                    </div>
                                    <div>
                                ...
                                <p className="text-muted mb-0">
                                    Vehicle Requested: <strong className="text-white">{currentRide?.vehicle}</strong>
                                </p>
                            </div>
                            ...
                            {currentRide?.paymentPref === 'Cash' ? (
                                <div>
                                    <h5 className="text-white mb-4">
                                        Please pay <strong className="text-purple">₹{currentRide?.fare} Cash</strong> to Captain {currentRide.captain}.
                                    </h5>
                                    <button 
                                        onClick={() => saveRideToDBAndFinish('Cash')} 
                                        className="btn btn-purple w-100 py-3 fw-bold fs-5 rounded-pill"
                                    >
                                ...
                                <div className="d-flex flex-column gap-3">
                                    <button 
                                        ...
                                        className="btn btn-success py-3 fw-bold fs-5 rounded-pill shadow-lg"
                                    >
                                        Secure Pay via Razorpay ✨
                                    </button>
                                    <button 
                                        onClick={() => saveRideToDBAndFinish('Online')} 
                                        className="btn btn-outline-purple py-3 fw-bold rounded-pill"
                                    >
                                        Test Bypass (Dummy Pay)
                                    </button>
                                </div>
                            )}
                         </div>
                 ...
                 <div className="glass-card p-4 rounded-4">
                     ...
                     {rideHistory.length > 0 ? rideHistory.map((r, i) => (
                         <div key={i} className="bg-black p-3 rounded-4 mb-3 border border-secondary d-flex justify-content-between align-items-center shadow-sm">
                            <div>
                                <p className="mb-0 fw-bold text-white">{r[3]} ➔ {r[4]}</p>
                                <small className="text-muted">{r[7]} • {r[2]}</small>
                            </div>
                            <h5 className="text-purple fw-bold mb-0">
                                ₹{r[5]} <span className="fs-6 text-muted d-block text-end">({r[6]})</span>
                            </h5>
                         </div>
             ...
             {activeTab === 'wallet' && (
                 <div className="glass-card p-4 rounded-4 text-white animate__animated animate__fadeIn">
                     <h4 className="text-purple">Wallet Balance</h4>
                     <h2 className="fw-bold mt-2">₹0.00</h2>
                     <button className="btn btn-outline-purple mt-3 fw-bold">Add Funds</button>
                 </div>
             )}

             {activeTab === 'refer' && (
                 <div className="glass-card p-4 rounded-4 text-center text-white animate__animated animate__fadeIn">
                     <h4 className="text-purple">Refer & Earn</h4>
                     <h2 className="fw-bold tracking-widest mt-2">RIDE-{userData?.phone?.slice(0,4)}</h2>
                     <p className="text-muted mt-2">Share this code with friends and earn VIP credits!</p>
                 </div>
             )}

             {activeTab === 'profile' && (
                 <div className="glass-card p-4 rounded-4 text-white animate__animated animate__fadeIn">
                     <h4 className="text-purple">My Profile</h4>
                     <h3 className="fw-bold mt-2">{userData?.name}</h3>
                     <p className="text-muted fs-5">{userData?.phone} • {userData?.city}</p>
                     <span className="badge bg-success py-2 px-3 rounded-pill mt-2">VIP Rider Activated</span>
                 </div>
             )}
          </div>
      </div>
  ...
  const CaptainPanel = () => {
    ...
    useEffect(() => {
      const watchId = navigator.geolocation.watchPosition(
          ...
          (err) => console.log("GPS Location Error: Device permission required."),
          { enableHighAccuracy: true }
      );

      socket.on('incoming_ride', (data) => { 
          if(!activeRide) setIncomingRide(data); 
      });

      socket.on('ride_started', (data) => { 
          if(activeRide && activeRide.id === data.id) { setActiveRide(data); } 
      });
          ...
          if (data.captainPhone === userData?.phone) { 
              ...
              setActiveRide(prev => { 
                  if (prev && prev.id === data.id && prev.status === 'confirming') { 
                      alert("Another captain accepted this ride!"); return null; 
                  } 
                  return prev; 
              });
          }
    ...
    return (
      <div className="container-fluid min-vh-100 p-0 row m-0 bg-black text-white">
          ...
          <div className="col-md-3 bg-dark border-end border-purple p-4 d-flex flex-column h-100 min-vh-100 shadow-lg">
              <div className="text-center mb-5 animate__animated animate__fadeIn">
                  <h4 className="fw-bold text-white">
                      <span className="text-purple">Ride</span>Ease Captain
                  </h4>
                  <div className="badge bg-success py-2 px-3 rounded-pill mt-2 fw-bold">
                      {userData?.name || userData?.phone}
                  </div>
              </div>
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold text-white border-0 ${activeTab==='radar'?'bg-purple':'btn-dark'}`}
              >
                  📡 Live Radar
              </button>
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold text-white border-0 ${activeTab==='earnings'?'bg-purple':'btn-dark'}`}
              >
                  💰 Earnings
              </button>
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold text-white border-0 ${activeTab==='vehicle'?'bg-purple':'btn-dark'}`}
              >
                  🏍️ Vehicle Docs
              </button>
          ...
          <div className="col-md-9 p-4 p-md-5 bg-black">
                     ...
                     {activeRide ? (
                         <div className="glass-card p-5 rounded-4 text-center animate__animated animate__fadeIn">
                             ...
                             {activeRide.status === 'completed' ? (
                                 ...
                                 <>
                                    <div className="spinner-border text-purple mb-3"></div>
                                    <h3 className="fw-bold text-purple tracking-widest">CONFIRMING...</h3>
                                    <p className="text-muted">Checking with server if you got the ride!</p>
                                 </>
                             ) : (
                                 <>
                                     ...
                                     <div className="bg-black border border-secondary p-4 rounded-4 text-start mb-4 shadow-sm">
                                         <p className="mb-2 text-white">
                                             <strong className="text-purple">Rider:</strong> {activeRide.riderName} ({activeRide.riderPhone})
                                         </p>
                                         <p className="mb-2 text-white">
                                             <strong className="text-purple">Pickup:</strong> {activeRide.pickup}
                                         </p>
                                         <p className="mb-0 text-white">
                                             <strong className="text-purple">Drop:</strong> {activeRide.drop}
                                         </p>
                                         <p className="mt-2 text-muted fw-bold">
                                             Vehicle: {activeRide.vehicle} | Pay: {activeRide.paymentPref}
                                         </p>
                                     </div>
                                     ...
                                     {activeRide.status === 'payment_pending' ? (
                                         <div className="mt-4 p-4 border rounded-4 bg-black border-purple">
                                             {activeRide.paymentPref === 'Cash' ? (
                                                 <>
                                                     <h4 className="fw-bold text-success mb-2">💵 Collect ₹{activeRide.fare} Cash</h4>
                                                     <p className="text-muted">Wait for the rider to confirm payment on their app.</p>
                                                 </>
                                             ) : (
                                                 <>
                                                     <div className="spinner-grow text-purple mb-3"></div>
                                                     <h5 className="fw-bold text-white">Waiting for Online Payment...</h5>
                                                     <p className="text-muted">Rider is completing Razorpay Checkout.</p>
                                                 </>
                                             )}
                                         </div>
                                         ...
                                         <div className="mt-4 p-4 border rounded-4 bg-black border-purple animate__animated animate__fadeInUp">
                                             ...
                                             <input 
                                                 type="number" 
                                                 className="form-control text-center fs-3 tracking-widest border border-purple" 
                                                 placeholder="----" 
                                                 value={otpInput} 
                                             ...
                                             <button 
                                                 onClick={verifyOTP} 
                                                 className="btn btn-purple w-100 py-3 fw-bold fs-5 rounded-pill mt-3"
                                             >
                                                 Start VIP Ride 🔒
                                             </button>
                                         </div>
                                         ...
                                         <button 
                                             onClick={() => socket.emit('finish_ride', activeRide)} 
                                             className="btn btn-danger w-100 py-3 fs-5 fw-bold mt-4 rounded-pill shadow-lg"
                                         >
                         ...
                         <div className="glass-card p-5 rounded-4 border-4 border-purple animate__animated animate__pulse animate__infinite">
                             ...
                             <p className="fs-5 text-white">
                                 Rider: <strong>{incomingRide.riderName}</strong>
                             </p>
                             <p className="fs-5 text-white">
                                 Pickup: <strong>{incomingRide.pickup}</strong>
                             </p>
                             <p className="fs-6 text-muted">
                                 Vehicle: {incomingRide.vehicle} | Payment: {incomingRide.paymentPref}
                             </p>
                             ...
                             <div className="d-flex gap-3">
                                 <button 
                                     onClick={acceptRide} 
                                     className="btn btn-purple flex-grow-1 py-3 fw-bold fs-5 rounded-pill"
                                 >
                                     ACCEPT
                                 </button>
                                 <button 
                                     onClick={()=>setIncomingRide(null)} 
                                     className="btn btn-outline-danger flex-grow-1 py-3 fw-bold rounded-pill"
                                 >
                                     REJECT
                                 </button>
                             </div>
             ...
             {activeTab === 'earnings' && (
                 <div className="glass-card p-4 rounded-4 text-center animate__animated animate__fadeIn">
                     <h4 className="fw-bold text-purple mb-3">Your Lifetime Earnings 💰</h4>
                     <h1 className="text-success display-2 fw-bold">
                         ₹{rideHistory.reduce((sum, r) => sum + r[5], 0)}
                     </h1>
                     <p className="text-muted mt-2">Paid out to your linked account.</p>
                 </div>
             )}
                 ...
                 <div className="glass-card p-4 rounded-4">
                     ...
                     {rideHistory.length > 0 ? rideHistory.map((r, i) => (
                         <div key={i} className="bg-black p-3 rounded-4 mb-3 border border-secondary d-flex justify-content-between align-items-center shadow-sm">
                            <div>
                                <p className="mb-0 fw-bold text-white">{r[3]} ➔ {r[4]}</p>
                                <small className="text-muted">{r[7]} • {r[1]}</small>
                            </div>
             ...
             {activeTab === 'vehicle' && (
                 <div className="glass-card p-4 rounded-4 text-white animate__animated animate__fadeIn">
                     <h4 className="text-purple fw-bold mb-4">Vehicle Documents</h4>
                     <ul className="list-group list-group-flush bg-transparent">
                         <li className="list-group-item bg-transparent text-white border-secondary d-flex justify-content-between py-3">
                             <span>Driving License</span> 
                             <span className="text-success fw-bold">Verified ✅</span>
                         </li>
                         <li className="list-group-item bg-transparent text-white border-secondary d-flex justify-content-between py-3">
                             <span>RC Book / Registration</span> 
                             <span className="text-success fw-bold">Verified ✅</span>
                         </li>
                         <li className="list-group-item bg-transparent text-white border-secondary d-flex justify-content-between py-3">
             ...
             {activeTab === 'profile' && (
                 <div className="glass-card p-4 rounded-4 text-white animate__animated animate__fadeIn">
                     <h4 className="text-purple">Captain Profile</h4>
                     <h3 className="fw-bold mt-2">{userData?.name}</h3>
                     <p className="text-muted fs-5">{userData?.phone} • Account Active 🟢</p>
                 </div>
             )}
          </div>
      </div>
    ...
    return (
      <div className="container-fluid min-vh-100 p-0 row m-0 bg-black text-white">
          ...
          <div className="col-md-3 bg-dark border-end border-danger p-4 d-flex flex-column h-100 min-vh-100 shadow-lg">
              <h4 className="text-danger fw-bold mb-5 mt-2 animate__animated animate__shakeX">
                  ADMIN PORTAL
              </h4>
              
              <button 
                  onClick={() => setActiveTab('dash')} 
                  className={`btn text-start mb-2 fw-bold ${activeTab==='dash'?'btn-danger text-black':'btn-dark'}`}
              >
                  📈 Dashboard
              </button>
              ...
              <button 
                  ...
                  className={`btn text-start mb-2 fw-bold ${activeTab==='liverides'?'btn-danger text-black':'btn-dark'}`}
              >
                  📍 Active Map
              </button>
              ...
              <button 
                  onClick={handleLogout} 
                  className="btn btn-outline-dark w-100 mt-auto fw-bold text-danger border-danger rounded-pill"
              >
                  Logout
              </button>
          </div>
              ...
              {activeTab === 'dash' && (
                  <div className="animate__animated animate__fadeIn">
                      ...
                      <div className="row g-4 mb-4">
                         <div className="col-3">
                             <div className="glass-card p-4 rounded-4 border-success">
                                 <h6 className="text-success fw-bold">Admin Commission (10%)</h6>
                                 <h1 className="text-success fw-bold">₹{dbStats.commission || 0}</h1>
                             </div>
                         </div>
                         <div className="col-3">
                             <div className="glass-card p-4 rounded-4 border-purple">
                                 <h6 className="text-muted">Total Users</h6>
                                 <h2 className="text-purple fw-bold">{dbStats.total_users}</h2>
                             </div>
                         </div>
                         <div className="col-3">
                             <div className="glass-card p-4 rounded-4 border-white">
                                 <h6 className="text-muted">Rides Locked</h6>
                                 <h2 className="text-white fw-bold">{dbStats.total_rides}</h2>
                             </div>
                         </div>
                         <div className="col-3">
                             <div className="glass-card p-4 rounded-4 border-info">
                                 <h6 className="text-muted">Live Active Requests</h6>
                                 <h2 className="text-info fw-bold">{stats.active}</h2>
                             </div>
                         </div>
                      </div>

                      <div className="glass-card p-4 rounded-4 border-danger">
                          <h5 className="text-danger fw-bold mb-2">System Status</h5>
                          <h3 className="text-success fw-bold">
                              SOCKET LIVE <span className="text-white fw-light fs-6">✅ {io().connected?'connected':'waiting'}</span>
                          </h3>
                      </div>
                  </div>
              )}
